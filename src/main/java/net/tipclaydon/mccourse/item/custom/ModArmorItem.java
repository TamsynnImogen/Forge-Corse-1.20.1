...
import net.tipclaydon.mccourse.item.ModArmorMaterials;
...
public class ModArmorItem extends ArmorItem {
    private static final Map<ArmorMaterial, List<MobEffectInstance>> MATERIAL_TO_EFFECT_MAP =
            (new ImmutableMap.Builder<ArmorMaterial, List<MobEffectInstance>>())
                    .put(ModArmorMaterials.ALEXANDRITE, List.of(new MobEffectInstance(MobEffects.JUMP, 200, 1),
                            new MobEffectInstance(MobEffects.GLOWING, 200, 1)))
                    .build();
